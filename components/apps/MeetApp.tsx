        ...
        <div className="flex flex-col h-full bg-[#202124] text-white font-sans items-center justify-center relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center max-w-6xl w-full px-8 animate-in fade-in zoom-in duration-500">
                ...
                <div className="flex-1 w-full max-w-sm flex flex-col items-center text-center space-y-8">
                    ...
                    <button onClick={enterCall} className="px-8 py-3 bg-[#8AB4F8] hover:bg-[#AECBFA] text-[#202124] rounded-full font-medium text-sm transition-all shadow-lg">Participar agora</button>
                </div>
            </div>
        </div>
      );
  ...
  return (
    <div className="flex flex-col h-full bg-[#202124] relative overflow-hidden text-white font-sans animate-in fade-in duration-500">
        ...
        <div className="h-20 bg-[#202124] flex items-center justify-between px-6 pb-4 shrink-0 fixed bottom-0 left-0 right-0 z-50">
            ...
            <div className="flex items-center gap-3">
                <button onClick={toggleMic} className={`p-3.5 rounded-full transition-all ${micOn ? 'bg-[#3C4043] hover:bg-[#4d5155] text-white' : 'bg-[#EA4335] hover:bg-[#D93025] text-white shadow-lg'}`}>{micOn ? <Mic size={20}/> : <MicOff size={20}/>}</button>
                ...
                <button onClick={() => { stopCamera(); setView('home'); peerRef.current?.destroy(); }} className="px-6 h-12 bg-[#EA4335] hover:bg-[#D93025] text-white rounded-full flex items-center gap-2 ml-2 shadow-lg"><PhoneOff size={22}/></button>
            </div>
