...
import { Search, Settings, X, Mail, FileText, User, Calendar, ExternalLink, HardDrive, ArrowRight, Globe, MapPin, Loader2, Sparkles } from 'lucide-react';
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        {groundingSources.map((source, i) => {
                                            if (source.web) {
                                                ...
                                                // Maps grounding chunk (simplified render)
                                                return (
                                                    <div key={i} className="bg-[#202124] p-4 rounded-xl border border-white/5 flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            {/* Actual maps grounding provides more data, using simplified title here */}
                                                        </div>
                                                    </div>
                                                )
                                            }
